...
Select Location, Population,date, MAX(CONVERT(FLOAT,total_cases)) as HighestInfectionCount,  Max((CONVERT(FLOAT,total_cases)/NULLIF(CONVERT(FLOAT,population),0)))*100 as PercentPopulationInfected
From PortfolioProject..CovidDeaths
--Where location like '%states%'
